/**
 * @file add-branches-modal.basic.spec.ts
 * @summary Module: tests/e2e/add-branches-modal.basic.spec.ts
 * @remarks
...
import { setupOfflineModeWithDisabledBranches, setupEmptyState } from "@tests/e2e/setup/intercepts";
