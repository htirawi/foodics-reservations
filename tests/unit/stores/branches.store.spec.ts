/**
 * @file branches.store.spec.ts
 * @summary Module: tests/unit/stores/branches.store.spec.ts
 * @remarks
...
describe("useBranchesStore", () => {
    ...
    describe("updateSettings (optimistic)", () => {
        ...
        it("throws error for non-existent branch", async () => {
            ...
            await expect(store.updateSettings("999", payload)).rejects.toThrow("Branch with id 999 not found");
        });
    });
