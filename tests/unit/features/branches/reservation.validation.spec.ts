/**
 * @file reservation.validation.spec.ts
 * @summary Module: tests/unit/features/branches/reservation.validation.spec.ts
 * @remarks
...
describe("reservation.validation", () => {
    describe("sanitizeDuration", () => {
        ...
        it("handles non-digit characters in strings", () => {
            ...
            expect(sanitizeDuration("12abc34")).toBe(1234);
        });
        ...
        it("handles number inputs correctly", () => {
            expect(sanitizeDuration(60)).toBe(60);
            expect(sanitizeDuration(120.5)).toBe(120);
