 ...
 * @summary Module: tests/unit/services/branches.service.spec.ts
 * @remarks
...
describe("BranchesService", () => {
    ...
    describe("updateBranchSettings", () => {
        ...
        it("should handle validation errors", async () => {
            ...
            await expect(BranchesService.updateBranchSettings("branch-123", updatePayload)).rejects.toMatchObject({
                status: 422,
                message: "Validation failed",
            } as ApiError);
        });
